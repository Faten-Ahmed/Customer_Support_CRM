...
import { ReportFilter, ReportService, SlaReport } from '../report.service';
...
export class SlaReportComponent implements OnInit {
  ...
  readonly report = signal<SlaReport | null>(null);
  ...
  byPriorityColumns = ['priority', 'compliant', 'breached'];
